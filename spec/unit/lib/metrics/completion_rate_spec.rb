...
describe Metrics::Volumetrics do
  ...
  describe "#execute" do
    before do
      FactoryBot.create(:user_details, created_at: earlier_today)
      ...
      FactoryBot.create(:user_details, :sms, created_at: earlier_today)
      ...
      FactoryBot.create(:user_details, :self_signed, created_at: earlier_today)
